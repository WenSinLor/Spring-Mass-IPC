...
def main():
    ...
    VIDEO_FILE = DATA_DIR / "camera_data" / "topology_15_prestress" / "C1437.MP4"
    OUTPUT_FILE = DATA_DIR / "experiment_data" / "topology_15_prestress" / "spring_mass_data.npz"
    ...
    tracker = MarkerTracker(lower_red1, upper_red1, lower_red2, upper_red2, min_area=5000, max_area=25000)
