...
def main():
    ...
    VIDEO_FILE = DATA_DIR / "camera_data" / "topology_9" / "C1415.MP4"
    OUTPUT_FILE = DATA_DIR / "experiment_data" / "topology_9" / "spring_mass_data.npz"
    ...
    tracker = MarkerTracker(lower_red1, upper_red1, lower_red2, upper_red2, min_area=9000, max_area=25000)
