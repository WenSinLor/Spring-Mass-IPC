...
VIDEO_FILE  = DATA_DIR / "camera_data"     / "topology_18_prestress" / "C1598.MP4"
OUTPUT_FILE = DATA_DIR / "experiment_data" / "topology_18_prestress" / "spring_mass_data.npz"
...
TRIAL_BATCHES = [
    ("topology_18", VIDEO_FILE, OUTPUT_FILE),
]
